...
.action(function(env){
  if (env != "root") {
      ...
      createDirsSync(env+'_site/static','/')
      createDirsSync(env+'_site/static/public','/')
      createDirsSync(env+'_site/images','/')
      createDirsSync(env+'_site/template','/')
      exists(gulpConfigPath, env+'_site/', copy );
  }else{
      var gulpConfigPath = process.mainModule.paths[0].substr(0,process.mainModule.paths[0].length-12)+'/gulpConfig/cottage'
      createDirsSync('static/','/')
      createDirsSync('images/','/')
      createDirsSync('template/','/')

      exists(gulpConfigPath, './', copy );
